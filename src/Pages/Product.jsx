...
const Product = () => {
  ...
  return (
    // <div className="_product_5bex1_1">
    //   <div className="_product-left_5bex1_6">
    //     <div className="_title_5bex1_58">
    //       <p>
    //         {` ${data.body.name} -
    //         ${SearchValue}`}
    //       </p>
    ...
    //         <img
    //           loading="eager"
    //           className="w-[340px] h-[300px] object-contain"
    //           src={data.body.image_url}
    //           alt="product-img"
    //         />
    //       </div>

    //       <div className="_box-container_5bex1_14">
    //         <div className="_box_5bex1_14 _blue_5bex1_102">
    //           <p className="_title_5bex1_58">Why sell with Us?</p>
    //           <div className="_box-pts_5bex1_91">
    //             <div className="_icons_5bex1_81">
    //               <svg
    //                 stroke="currentColor"
    //                 fill="currentColor"
    //                 strokeWidth={0}
    ...
    //     </div>
    //   </div>
    //   <div className="_product-right_5bex1_10">
    //     <form onSubmit={(e) => console.log(e)} action="">
    //       <div className="_title_5bex1_58">
    //         <p>About your Set</p>
    //       </div>
    //       <div className="_box-container_5bex1_14">
    //         <div className="_box_5bex1_14 _green_5bex1_105">
    //           <p className="_title_5bex1_58">Set Condition</p>
    // <div className="_box-contents_5bex1_18">
    //   <label>
    //     <img src="/Images/mint-6e3bd362.png" alt="mint" />
    //     <input type="checkbox" className="hidden" id="mintCheckbox" />
    //   </label>

    //   <label>
    //     <img src="/Images/very-good-64c6e7cf.png" alt="very-good" />
    //     <input
    //       type="checkbox"
    //       className="hidden"
    //       id="veryGoodCheckbox"
    ...
    //   <label>
    //     <img src="/Images/damaged-df96ca46.png" alt="damaged" />
    //     <input
    //       className="hidden"
    //       type="checkbox"
    //       id="damagedCheckbox"
    ...
    //       <br />
    //       <div className="_box-container_5bex1_14">
    //         <div className="_box_5bex1_14 _green_5bex1_105 _mr-gold_5bex1_32">
    //           <div>
    //             <img
    //               className=""
    ...
    //       <br />
    //       <div className="_box-container_5bex1_14">
    //         <div className="_box_5bex1_14 _green_5bex1_105 _getQuote_5bex1_44">
    //           <p className="_title_5bex1_58">Email Address*</p>
    //           <br />
    //           <TextInput type="email" required placeholder="Enter your email" />
    //           <br />
    //           <button
    //             onClick={() =>
    ...
    <div className="flex lg:flex-row flex-col">
      <div className="flex-1 py-5 px-6 lg:px-24">
        <div className="flex items-center max-w-lg flex-col justify-center">
          ...
          <div className="">
            <img
              loading="eager"
              className="w-[340px] h-[280px] object-contain"
              src={data.body.image_url}
              alt="product-img"
            />
          </div>
      ...
      <div className="flex-1 py-6 lg:py-0">
        <form action="">
          <div className="max-w-[440px] px-6 lg:px-0">
            <h2 class="mt-5 text-2xl text-center py-4 font-bold leading-9 tracking-tight text-gray-900">
              About your Set
            </h2>
            <div className="max-w-lg space-y-5">
              <div className="border-2 border-black rounded-3xl px-6 py-4 bg-[#6af99e]">
                ...
                <div className="flex items-center justify-between">
                  <label>
                    <img
                      className="md:w-[100px] object-contain h-[70px]"
                      src="/Images/mint-6e3bd362.png"
                      alt="mint"
                    />
                    <input
                      type="checkbox"
                  ...
                  <label>
                    <img
                      className="w-[100px] object-contain h-[70px]"
                      src="/Images/very-good-64c6e7cf.png"
                      alt="very-good"
                    />
                    <input
                      type="checkbox"
                  ...
                  <label>
                    <img
                      className="w-[100px] object-contain h-[70px]"
                      src="/Images/damaged-df96ca46.png"
                      alt="damaged"
                    />
                    <input
                      className="hidden"
